    ...
    <div className="2xl:container mx-auto px-5 sm:px-12 lg:px-28 py-10 pb-20 sm:py-20">
      <div className="grid grid-cols-1 sm:grid-cols-2 items-center">
        <div className="flex flex-col gap-3 p-4 uppercase">
          ...
          <p className={`text-xl font-${activeSlide === 0 ? 'semibold' : 'light'}`}>Estate planning & structuring</p>
          <hr className={`w-${activeSlide === 0 ? 'full' : '[90%]'} h-1 text-gray`} />
          <p className={`text-xl font-${activeSlide === 1 ? 'semibold' : 'light'}`}>Real estate solutions</p>
          <hr className={`w-${activeSlide === 1 ? 'full' : '[90%]'} h-1 text-gray`} />
          <p className={`text-xl font-${activeSlide === 2 ? 'semibold' : 'light'}`}>Private office</p>

  ...
  return (
    <div className="2xl:container relative h-[450px] w-full text-center mx-auto">
      <img
        ...
        alt='blue-circle'
        className="w-[450px] h-full object-fit mx-auto"
      />
      <img
        src={'/images/blue.png'}
        alt='Shadow'
        className="w-[450px] h-full object-fit mx-auto absolute top-0 left-0 md:top-11 md:left-96 opacity-20"
      />
      <div className="absolute top-52 md:top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-3xl md:text-5xl lg:text-7xl leading-tight font-light">
        here’s a teeny-weeny glimpse of our work. what’s coming later is even greater
      </div>
    </div>
  );
};

  ...
  return (
    <div>
      ...
      <div className="flex flex-col relative items-center justify-center py-20 pb-60 sm:pb-48">
        ...
        <div className="sm:text-center px-4 sm:px-0 z-10 absolute w-full firstText sm:left-[28.5%] mt-[64%] sm:mt-0">
        ...
        <div className="sm:text-center px-4 sm:px-0 z-10 absolute w-full secondText top-1/2 sm:top-[45%] sm:left-[22%]">
